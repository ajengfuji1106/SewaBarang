...
var O = function(e3, n2) {
  n2 = n2 || {}, C(function() {
    ...
    r2 = d(e3, i2, q, n2.reportAllChanges), c2 && ("PerformanceEventTiming" in self && "interactionId" in PerformanceEventTiming.prototype && c2.observe({ type: "first-input", buffered: true }), p(function() {
      o2(c2.takeRecords()), r2(true);
    }), a(function() {
      x = 0, F.length = 0, D.clear(), i2 = f("INP"), r2 = d(e3, i2, q, n2.reportAllChanges);
    }));
  });
};
var N = [2500, 4e3];
...
var _ = function(e3, n2) {
  n2 = n2 || {}, C(function() {
    ...
    if (c2) {
      t2 = d(e3, i2, N, n2.reportAllChanges);
      var m2 = v(function() {
        j[i2.id] || (o2(c2.takeRecords()), c2.disconnect(), j[i2.id] = true, t2(true));
      });
      ["keydown", "click"].forEach(function(e4) {
        addEventListener(e4, function() {
          return e5 = m2, n3 = self.requestIdleCallback || self.setTimeout, t3 = -1, e5 = v(e5), "hidden" === document.visibilityState ? e5() : (t3 = n3(e5), p(e5)), t3;
          var e5, n3, t3;
        }, true);
      }), p(m2), a(function(r3) {
        i2 = f("LCP"), t2 = d(e3, i2, N, n2.reportAllChanges), l(function() {
          i2.value = performance.now() - r3.timeStamp, j[i2.id] = true, t2(true);
        });
      });
    }
  });
...
var J = function(e3, n2) {
  n2 = n2 || {};
  var t2 = f("TTFB"), r2 = d(e3, t2, z, n2.reportAllChanges);
  G(function() {
    var i2 = c();
    i2 && (t2.value = Math.max(i2.responseStart - u(), 0), t2.entries = [i2], r2(true), a(function() {
      t2 = f("TTFB", 0), (r2 = d(e3, t2, z, n2.reportAllChanges))(true);
    }));
  });
};
var K = { passive: true, capture: true };
var Q = /* @__PURE__ */ new Date();
var U = function(e3, i2) {
  n || (n = i2, t = e3, r = /* @__PURE__ */ new Date(), X(removeEventListener), V());
};
var V = function() {
  if (t >= 0 && t < r - Q) {
  ...
  if (e3.cancelable) {
    ...
    "pointerdown" == e3.type ? function(e4, n3) {
      var t2 = function() {
        ...
        removeEventListener("pointerup", t2, K), removeEventListener("pointercancel", r2, K);
      };
      addEventListener("pointerup", t2, K), addEventListener("pointercancel", r2, K);
    }(n2, e3) : U(n2, e3);
  }
};
var X = function(e3) {
...
var Z = function(e3, r2) {
  r2 = r2 || {}, C(function() {
    ...
    o2 = d(e3, u2, Y, r2.reportAllChanges), h2 && (p(v(function() {
      m2(h2.takeRecords()), h2.disconnect();
    })), a(function() {
      var a2;
      u2 = f("FID"), o2 = d(e3, u2, Y, r2.reportAllChanges), i = [], t = -1, n = null, X(addEventListener), a2 = l2, i.push(a2), V();
    }));
  });
};
export {
